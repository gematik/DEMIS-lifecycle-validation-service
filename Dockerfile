...
COPY --chown=$USERID:$GROUPID target/lifecycle-validation-service.jar /app.jar
...
LABEL de.gematik.vendor="gematik GmbH" \
      ...
      de.gematik.app="DEMIS lifecycle-validation-service" \
      de.gematik.git-repo-name="https://gitlab.prod.ccs.gematik.solutions//git/demis/services/lifecycle-validation-service" \
